...
public class Main2Activity extends AppCompatActivity implements
    ...
    private EditText mPhoneNumberField,name,address,bussinessname;
  ...
  //  private  Button mSavebutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  bussinessname=(EditText)findViewById(R.id.field_business);
       ...
       // cardView=(CardView)findViewById(R.id.saveDatacard);
...
/*
                            myRef.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot snapshot) {
                                    if (snapshot.getValue() != null) {
                                        ...
                                        Intent y = new Intent(Main2Activity.this, FormActivity.class);
                                        y.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                        y.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                        startActivity(y);
                                      ...
                                      *//*  SharedPreferences mPreferences;
                                        ...
                                        myRef.child(userID).child("contact").setValue(contactno);
                            ...
                            put.put("contact", userID);
                            db.collection("users").document(userID).set(put,SetOptions.merge()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
        ...
        switch (uiState) {
            ...
            case STATE_CODE_SENT:
              ...
              //  cardView.setVisibility(View.GONE);
                ...
                Toast.makeText(Main2Activity.this, "code sent", Toast.LENGTH_LONG).show();
                break;
            case STATE_VERIFY_FAILED:
                ...
                Toast.makeText(Main2Activity.this, "verification failed", Toast.LENGTH_LONG).show();
                break;
            case STATE_VERIFY_SUCCESS:
                ...
                Toast.makeText(Main2Activity.this, "verification success", Toast.LENGTH_LONG).show();
